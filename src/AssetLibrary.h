...
enum class Kind { Folder, Script, Prefab, Scene, Input, Image, Model, Shader, Material, Audio, Lightmap, File };
...
inline void Icon(HDC dc,Kind kind,int x,int y) {
    const COLORREF colors[]={RGB(217,178,89),RGB(133,199,144),RGB(120,174,236),RGB(182,159,227),RGB(219,155,107),RGB(137,194,209),RGB(122,179,227),RGB(226,140,196),RGB(120,206,196),RGB(167,174,186),RGB(236,222,140),RGB(167,174,186)};
